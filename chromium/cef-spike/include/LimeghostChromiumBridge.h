...
@protocol LimeghostChromiumBridgeDelegate <NSObject>
...
@interface LimeghostChromiumHostView : NSView

@property(nonatomic, weak, nullable) id<LimeghostChromiumBridgeDelegate> delegate;
