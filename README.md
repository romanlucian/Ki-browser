...
- The folder icon picker offers three sets. The Clearframe set (104 icons) is the project's own artwork, and the only one a folder tint can recolour. The rest are licensed, carry their own colours, and are credited in the picker wherever they are shown:
