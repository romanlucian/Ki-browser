...
- source-language extraction of a page's rendered reading text with interface noise removed, a read-time estimate, explained risk signals, and Copy for AI, which shows the complete payload before it copies;
