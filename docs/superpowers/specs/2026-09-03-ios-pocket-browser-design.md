...
*Amended September 13, 2026:* the phone does not reference `BookmarksHomePage` or `HistoryHomePage`. It has phone-shaped Bookmarks and History sheets over the same store, search filters and day grouping; see [2026-09-13-ios-bookmarks-history-design.md](2026-09-13-ios-bookmarks-history-design.md), §9. `LimeghostIconView` is referenced as planned.
