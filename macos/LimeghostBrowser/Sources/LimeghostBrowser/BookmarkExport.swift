...
/// browser can read back in, so leaving Limeghost is as easy as arriving.
...
enum BookmarkExportCommand {
    static func run(store: BrowserDataStore) {
        ...
        panel.nameFieldStringValue = "Limeghost Bookmarks.html"
        ...
        do {
            ...
            alert.informativeText = "Limeghost couldn't write that file. Check that the location is still available, then try again."
