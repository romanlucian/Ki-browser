...
enum BookmarkBarMetrics {
    ...
    static let folderIconSize: CGFloat = LimeghostTheme.siteIconSize
...
struct BookmarksBar: View {
    ...
    var body: some View {
        ...
        .background(isRootDropTargeted ? LimeghostTheme.accentDim : LimeghostTheme.bg1)
        .overlay(alignment: .bottom) {
            Rectangle()
                .fill(isRootDropTargeted ? LimeghostTheme.accent : LimeghostTheme.hairline1)
...
private struct BookmarksBarAllChip: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .foregroundStyle(isHovered ? LimeghostTheme.textPrimary : LimeghostTheme.textSecondary)
            .padding(.horizontal, BookmarkBarMetrics.itemPadding)
...
private struct BookmarkBarLink: View {
    ...
    private static let iconWidth: CGFloat = LimeghostTheme.siteIconSize
...
private struct BookmarkFolderMenu: View {
    ...
    private var chipFill: Color {
        if isDropTargeted { return LimeghostTheme.accentDimStrong }
        return isHovered ? LimeghostTheme.itemHover : Color.clear
    }
    ...
    private var chipLabel: some View {
        HStack(spacing: BookmarkBarMetrics.iconGap) {
            ...
            .background(chipFill, in: RoundedRectangle(cornerRadius: LimeghostTheme.radius6))
            .overlay {
                if isDropTargeted {
