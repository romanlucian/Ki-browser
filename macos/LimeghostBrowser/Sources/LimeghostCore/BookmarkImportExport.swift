...
/// bookmark entry point in Limeghost is: `WebURLPolicy` has approved the
...
/// folders and bookmarks. Merging this into Limeghost's own
...
/// Everything that can go wrong reading a file Limeghost did not write,
...
public enum BookmarkImportError: Error, Equatable, Sendable {
    ...
    /// Limeghost recognizes — not a Chromium bookmarks file.
    case missingRoots
