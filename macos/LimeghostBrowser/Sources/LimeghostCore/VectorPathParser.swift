...
public struct VectorShape: Equatable, Sendable {
    ...
    /// caller is using. That is the Limeghost set's whole convention, and the
    ...
    /// `nil` leaves the choice to the style: the Limeghost set is drawn to be
...
///
/// Foundation-only, like the rest of `LimeghostCore`: `CGPoint` and `CGSize`
...
public enum VectorPathParser {
    ...
    private static func append(
        ...
        // The Limeghost set names no paint at all: a bare element is a stroke
