...
/// The 104 hand-drawn Limeghost folder icons, shipped in the app the same
...
enum LimeghostIconCatalogData {
    ...
    private static let work: [LimeghostIcon] = [
    ...
    private static let creative: [LimeghostIcon] = [
    ...
    private static let reading: [LimeghostIcon] = [
    ...
    private static let shopping: [LimeghostIcon] = [
    ...
    private static let travel: [LimeghostIcon] = [
    ...
    private static let code: [LimeghostIcon] = [
    ...
    private static let people: [LimeghostIcon] = [
    ...
    private static let media: [LimeghostIcon] = [
    ...
    private static let home: [LimeghostIcon] = [
    ...
    private static let markers: [LimeghostIcon] = [
    ...
    private static let nature: [LimeghostIcon] = [
    ...
    private static let objects: [LimeghostIcon] = [
    ...
    private static let interface: [LimeghostIcon] = [
    ...
    private static func icon(
        ...
        LimeghostIcon(id: id, category: category, markup: markup)
    }
}
