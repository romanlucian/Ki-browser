...
final class LimeghostCoreTests: XCTestCase {
    ...
    func testEverySearchEngineBuildsAnHTTPSResultsURL() {
        let query = "limeghost privacy & sources"
    ...
    func testBookmarkBarQueriesSeparateTopLevelItemsFromNestedContents() throws {
        ...
        let direct = BookmarkRecord(title: "Limeghost", url: "https://example.com/limeghost")
    ...
    func testEditingABookmarkRefusesAnAddressLimeghostWouldNotSave() throws {
        var collection = BookmarkCollection()
