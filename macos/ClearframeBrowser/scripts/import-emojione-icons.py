...
icons in place, and do not merge them with Clearframe's own set.
...
def main():
    ...
    destination = pathlib.Path(__file__).resolve().parent.parent / "Sources/ClearframeCore"
    ...
    index_text = "\n".join([
        ...
        f"    static let icons: [ClearframeIcon] = {joined}",
        "}",
        "",
    ])
